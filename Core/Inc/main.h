...
#define MOTOR2_ENCODER_IN1_Pin GPIO_PIN_0
#define MOTOR2_ENCODER_IN1_GPIO_Port GPIOA
#define MOTOR2_ENCODER_IN1_EXTI_IRQn EXTI0_IRQn
#define MOTOR2_ENCODER_VCC_Pin GPIO_PIN_1
#define MOTOR2_ENCODER_VCC_GPIO_Port GPIOA
#define MOTOR4_OUTPUT_Pin GPIO_PIN_2
#define MOTOR4_OUTPUT_GPIO_Port GPIOA
...
#define MOTOR3_OUTPUT_Pin GPIO_PIN_6
#define MOTOR3_OUTPUT_GPIO_Port GPIOC
...
#define MOTOR1_ENCODER_IN1_Pin GPIO_PIN_8
#define MOTOR1_ENCODER_IN1_GPIO_Port GPIOA
#define MOTOR1_ENCODER_IN1_EXTI_IRQn EXTI9_5_IRQn
#define MOTOR1_ENCODER_VCC_Pin GPIO_PIN_9
#define MOTOR1_ENCODER_VCC_GPIO_Port GPIOA
