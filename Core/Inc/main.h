...
#define MOTOR2_ENCODERB_Pin GPIO_PIN_0
#define MOTOR2_ENCODERB_GPIO_Port GPIOA
#define MOTOR2_ENCODERA_Pin GPIO_PIN_1
#define MOTOR2_ENCODERA_GPIO_Port GPIOA
